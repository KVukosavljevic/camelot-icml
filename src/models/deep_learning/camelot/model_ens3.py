...
from src.models.deep_learning.model_blocks import MLP, AttentionRNNEncoderMod
...
class CAMELOT(tf.keras.Model):
    ...
    def encoder_forward_pass(self, inputs):
        ...
        # Dynamic features, static are added to o_hat
        z = self.Encoder((inputs_dynamic, inputs_static)) # 64 unit output
